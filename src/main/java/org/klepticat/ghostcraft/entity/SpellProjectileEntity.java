...
public class SpellProjectileEntity extends ProjectileEntity implements FlyingItemEntity {
    ...
    public SpellProjectileEntity(MagicType magicType, LivingEntity owner, World world) {
        super(AllEntityTypes.SPELL_PROJECTILE, world);
        switch (magicType) {
            case MAGIC -> { this.getDataTracker().set(ITEM, new ItemStack(AllItems.MAGIC_CHARGE)); }
    ...
    protected void onEntityHit(EntityHitResult entityHitResult) {
        ...
        entity.damage(this.getDamageSources().thrown(this, this.getOwner()), (float)2);
    }
    ...
    protected Item getDefaultItem() { return AllItems.DIRE_CHARGE; }
